...
use yzh52521\jwt\Encoding\ChainedFormatter;
...
final class Jwt extends Component implements JwtSigner,JwtKey
{
    ...
    /**
     * @var int
     * You should specify \yzh52521\jwt\Jwt::$signerKeyContents if value deffer from JwtKey::EMPTY
     */
    public int $signerKey = JwtKey::EMPTY;

    /**
     * @var Closure|string
     * Should not be empty string if \yzh52521\jwt\Jwt::$signerKey has other value than JwtKey::EMPTY
     */
